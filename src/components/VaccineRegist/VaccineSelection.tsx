      ...
      <TabPane tab="Vắc xin gói" key="1">
        <Collapse>
          ...
          <div style={{ display: "flex", flexWrap: "wrap" }}>
              <VaccineCard name="Gói Hexaxim - Rotarix - Varivax" price="24,833,332" description="Gói vắc xin Hexaxim–Rotarix–Varilrix (0-9 tháng) có đủ các vắc xin cho trẻ ở 1 năm đầu đời" />
              <VaccineCard name="Gói Hexaxim - Rotateq - Varivax" price="25,218,252" description="Gói vắc xin Hexaxim–Rotatequ Varilrix (0-9 tháng) có đủ các vắc xin cho trẻ ở 1 năm đầu đời." />
            </div></Panel>
          ...
          <div style={{ display: "flex", flexWrap: "wrap" }}>
              <VaccineCard name="Gói Hexaxim - Rotarix - Varivax" price="24,833,332" description="Gói vắc xin Hexaxim–Rotarix–Varilrix (0-24 tháng) có đủ các vắc xin cho trẻ ở 1 năm đầu đời" />
              <VaccineCard name="Gói Hexaxim - Rotateq - Varivax" price="25,218,252" description="Gói vắc xin Hexaxim–Rotatequ Varilrix (0-24 tháng) có đủ các vắc xin cho trẻ ở 1 năm đầu đời." />
            </div></Panel>
        </Collapse>
      </TabPane>
